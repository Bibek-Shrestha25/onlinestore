...
const Navbar = () => {
  return (
    <nav className="bg-slate-400">
      <div className="max-w-6xl m-auto px-3 sm:px-1 lg:px-5">
        <div className="flex justify-between h-16">
          <div className="flex items-center">
            <Link to="/" className="text-4xl font-bold text-white-500">
          ...
          <div className="hidden sm:flex sm:items-center sm:ml-6">
            ...
            <div className="ml-4 flex items-center">
              <input
                className="rounded-l-lg p-1 border-t border-b border-l text-slate-800 border-white-200 bg-green"
                placeholder="Search"
              />
              <button className="px-2 py-1 rounded-r-lg bg-blue-500 text-white font-bold uppercase border-t border-b border-r">
                <svg className="h-6 w-5 fill-current" viewBox="0 0 24 24">
                  <path
                    fillRule="evenodd"
